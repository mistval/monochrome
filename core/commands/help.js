...
class Help {
  constructor(helpCommandHelper, config) {
    ...
    this.commandsForTopLevelHelp_ = helpCommandHelper.getNonHiddenCommands()
  ...
  async showGeneralHelp_(msg, helpCommandHelper) {
    const commandsToDisplayHelpFor = await helpCommandHelper.getEnabledNonHiddenCommands(msg);
