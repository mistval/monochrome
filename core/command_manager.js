...
class CommandManager {
  ...
  async load(directory, monochrome) {
    ...
    try {
      ...
      this.helpCommandHelper_ = new HelpCommandHelper(this.commands_, this.config_, this.settings_);
      if (this.config_.commandsToGenerateHelpFor.length !== 0 && this.config_.autoGeneratedHelpCommandAliases.length !== 0) {
        let helpCommandData = this.helpCommandHelper_.generateHelpCommandData();
